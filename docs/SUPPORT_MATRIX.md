...
| S14 | Read-only path validation and managed Vim/open-directory action | Conditional | POSIX and Windows drive/UNC syntax without unquoted spaces; pane identity/path is revalidated before action. |
