        ...
        try:
            while True:
                ...
                if profile is DESKTOP:
                    ...
                    # Show the two discoverable entry points without creating
                    # or changing project/session data. Session management is
                    # demonstrated in the main guided workflow recording.
                    cue_once(
                        "new-project-cue",
                        0.6,
